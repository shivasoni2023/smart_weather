            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Made By Shiva",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "shiva",fontSize: 20),),
                    Text("Data Provided By Open weather map.org",style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "shiva",fontSize: 15))
                  ],
                ),
              )
            ],
